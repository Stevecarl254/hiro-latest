        ...
        {!selectedQuote && (
          <div className="flex flex-col items-center mt-6 md:mt-10 animate-bip-text">
            <svg viewBox="0 0 300 150" className="w-[180px] md:w-[300px] h-auto overflow-visible">
              <path d="M0,130 C75,0 225,0 300,130" stroke="currentColor" strokeWidth="2" fill="transparent" strokeDasharray="6 6" className="text-orange-500" />
              <polygon points="295,125 305,130 295,135" fill="currentColor" className="text-orange-500" />
              <polygon points="5,125 15,130 5,135" fill="currentColor" className="text-orange-500" />
            </svg>
            <span className="mt-2 text-[#001f3f] dark:text-[#5cc3ff] font-bold text-center text-sm md:text-lg">
